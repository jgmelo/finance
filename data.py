...
crypto_jvm = {
    ...
    'COMPRA_011': {'Data'      : datetime.strptime("2025-03-31 11:49:49", "%Y-%m-%d %H:%M:%S"),
                   'Reais'     : 1000.0                                                       ,
                   'Cripto'    : 'Ethereum'                                                   ,
                   'Quantidade': 0.09394978                                                   ,
                   'Preço'     : 10644.0                                                      ,
                   }                                                                          ,
    'COMPRA_012': {'Data'      : datetime.strptime("2025-04-06 20:17:18", "%Y-%m-%d %H:%M:%S"),
                   'Reais'     : 1000.0                                                       ,
                   'Cripto'    : 'Ethereum'                                                   ,
                   'Quantidade': 0.10841904                                                   ,
                   'Preço'     : 9223.47                                                      ,
                   }                                                                          ,
    'COMPRA_013': {'Data'      : datetime.strptime("2025-11-30 19:50:52", "%Y-%m-%d %H:%M:%S"),
                   'Reais'     : 1000.0                                                       ,
                   'Cripto'    : 'Ethereum'                                                   ,
                   'Quantidade': 0.06111025                                                   ,
                   'Preço'     : 16363.8669454                                                ,
                   }                                                                          ,
}
